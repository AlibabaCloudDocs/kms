...
-   [Envelope encryption](#li_7t1_wkl_j1k)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/1422781/156707388958526_en-US.png)
...
-   [Envelope decryption](#li_jr5_gbw_ni2)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/1422781/156707388958527_en-US.png)
...
|[GenerateDataKey](https://help.aliyun.com/document_detail/28948.html)|Generates a data key, uses the specified CMK to encrypt the data key, and then returns a plaintext data key and a ciphertext data key.|
|[Decrypt](https://help.aliyun.com/document_detail/28950.html)|Decrypts data that is encrypted by KMS, including the ciphertext data key generated by calling the GenerateDataKey operation. You do not need to specify a CMK.|
