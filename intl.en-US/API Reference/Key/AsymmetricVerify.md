...
In this example, the asymmetric key whose ID is `5c438b18-05be-40ad-b6c2-3be6752c****` and version ID is `2ab1a983-7072-4bbc-a582-584b5bd8****` and the signature algorithm RSA\_PSS\_SHA\_256 are used to verify the digital signature `****==` of the digest `ZOyIygCyaOW6GjVnihtTFtIS9PNmskdyMlNKiuyjfzw=`.
...
|Digest|String|Yes|ZOyIygCyaOW6GjVnihtTFtIS9PNmskdyMlNKiuy\*\*\*\*=|The digest that is generated for the original message by using a hash algorithm. The hash algorithm is specified by the **Algorithm** parameter.
