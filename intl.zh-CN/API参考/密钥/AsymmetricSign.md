...
|Digest|String|是|ZOyIygCyaOW6GjVnihtTFtIS9PNmskdyMlNKiuyjfzw=|使用**Algorithm**中对应的哈希算法，对原始消息生成的摘要。

 **说明：** 使用Base64编码。 |
|KeyId|String|是|5c438b18-05be-40ad-b6c2-3be6752c\*\*\*\*|主密钥（CMK）的全局唯一标识符。

 **说明：** 该参数也可以被指定为主密钥绑定的别名，详情请参见[别名使用说明](~~68522~~)。 |
