...
本文将提供一个示例，使用密钥ID为`5c438b18-05be-40ad-b6c2-3be6752c****`、密钥版本ID为`2ab1a983-7072-4bbc-a582-584b5bd8****`的非对称密钥，通过签名算法RSA\_PSS\_SHA\_256对摘要信息`ZOyIygCyaOW6GjVnihtTFtIS9PNmskdyMlNKiuyjfzw=`生成的签名值`****==`进行验证。

## 调试

[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/#product=Kms&api=AsymmetricVerify&type=RPC&version=2016-01-20)
...
|Digest|String|是|ZOyIygCyaOW6GjVnihtTFtIS9PNmskdyMlNKiuy\*\*\*\*=|使用**Algorithm**中对应的哈希算法，对原始消息生成的摘要。
